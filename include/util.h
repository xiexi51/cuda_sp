...
struct CSR
{
    CSR(int out_num_v, int out_num_e, int *outptr, int *outcoo_row, int *outidx, float *outval) : num_v(out_num_v), num_e(out_num_e), ptr(outptr), coo_row(outcoo_row), idx(outidx), val(outval) {}
